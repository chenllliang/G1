...
from vlmgym.sandbox.games import Game2048, GameBreakout, GameMatch, GameMatchCifar
...
# META_SANDBOX.random_step_sandbox([250]*4)
    ...
    def fit(self):
        ...
        for _ in range(self.config.trainer.total_episodes):
            for batch_dict in self.train_dataloader:
                ...
                META_SANDBOX.random_step_sandbox([250]*4, close_render=True)
                    ...
                    with _timer("adv", timing_raw):
                        ...
                        for i in range(len(nested_reward_batch[0])):
                            for j in range(self.config.worker.rollout.n):
                                reward_batch.append(nested_reward_batch[j][i])
