...
class RLHFDataset(Dataset):
    ...
    def __init__(
        self,
        data_path: Optional[Union[str, Dataset]],
        tokenizer: PreTrainedTokenizer,
        processor: Optional[ProcessorMixin],
        prompt_key: str = "prompt",
        answer_key: str = "answer",
        image_key: str = "images",
        perception_key: str = "perception",
        use_groundtrurh_perception: bool = False,
        ...
        self.use_groundtrurh_perception = use_groundtrurh_perception
        ...
        if not isinstance(data_path, str): # dataset on the fly
    ...
    def __getitem__(self, index):
        ...
        if not self.use_groundtrurh_perception:
            ...
            messages = [
                ...
                {"role": "assistant", "content": row_dict[self.perception_key]}
            ]
            if self.system_prompt:
                messages.insert(0, {"role": "system", "content": self.system_prompt})
