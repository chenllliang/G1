...
from sandbox.games import GameMatchCifar
...
# random policy
def random_policy(image_path_lists, prompt_lists):
    """
...
if __name__=="__main__":
    ...
    SAVE_NAME = "test_shisensho_cifar10"
    ...
    plt.title("Shisensho-CIFAR10 Culcumulated Reward of Each Run")
    plt.xlabel("Step")
